export const layout_parser = (function() {
    "use strict";
  ...
  function peg$parse(input, options) {
    ...
    var peg$e3 = peg$classExpectation(["c", "t", "i"], false, false);
    var peg$e4 = peg$classExpectation(["v", "h"], false, false);
    var peg$e5 = peg$classExpectation(["%", "^"], false, false);
  
    var peg$f0 = function(layout) {
        return layout;
    };
    var peg$f1 = function(mod, flex, layout) {
        let str;
        switch (flex) {
          case 'v':
    ...
    var peg$f2 = function(blocks) {
        return blocks.join('');
    };
    var peg$f3 = function(mod, block) {
        let str;
